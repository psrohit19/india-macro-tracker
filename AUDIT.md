...
| fx_reserves | week ended 2026-06-26 | US$ 666.93 bn | https://www.rbi.org.in/Scripts/WSSViewDetail.aspx?TYPE=Section&PARAM1=2 | LIVE (rbi_wss.py, 34 wkly obs). Cross-checked vs WSS-Extract press release (prid=63081) and press coverage: Business Standard / Xinhua "forex reserves drop $5.65 bn to $666.93 bn" (Jul 3, 2026). |
| m3 | fortnight ended 2026-06-15 | 11.9 % YoY | https://www.rbi.org.in/Scripts/WSSViewDetail.aspx?TYPE=Section&PARAM1=7 | LIVE (rbi_wss.py, 18 fortnightly obs). Value as printed in WSS Money Stock table (merger-inclusive); internally consistent with component YoY rows; deposits/credit from same WSS issue corroborate. |
| credit | fortnight ended 2026-06-15 | 17.7 % YoY | https://www.rbi.org.in/Scripts/WSSViewDetail.aspx?TYPE=Section&PARAM1=3 | LIVE (rbi_wss.py, 16 obs). Cross-checked vs Sectoral Deployment PR (non-food credit 17.4% YoY as on 2026-05-31, prid=63052) and press: "bank credit growth robust at 17.1% in FY26" (Tribune). NB: sharp acceleration from ~11% (late 2025) is genuine in source. |
| deposits | fortnight ended 2026-06-15 | 12.0 % YoY | https://www.rbi.org.in/Scripts/WSSViewDetail.aspx?TYPE=Section&PARAM1=2 | LIVE (rbi_wss.py, 16 obs). Same WSS table as credit; matches WSS-Extract press release (prid=63081) print "2.1a Growth ... 12.0". |
| cards | 2026-05 | ₹ 2.023 lakh cr | https://www.rbi.org.in/Scripts/ATMView.aspx | LIVE (rbi_files.py, 17 mthly obs; credit-card PoS+e-com value summed over 63 bank rows). Cross-checked vs RBI PSI May-2026 xlsx credit-card total ₹2.027 lakh cr (0.2% gap = coverage/rounding); Jan-2025 obs (1.841) matches publicly reported ₹1.84 lakh cr. |
| upi | 2026-05 | ₹ 29.90 lakh cr | https://www.rbi.org.in/Scripts/PSIUserView.aspx | LIVE (rbi_psi.py, 24 mthly obs; NPCI blocks bots so RBI PSI mirror used). Cross-checked vs press: ANI "UPI hits new high in May 2026 ... worth Rs 29.9 trillion, NPCI data"; 2024-25 back-months match NPCI public record (e.g. May-25 = 25.14). |
| walr | 2026-05 | 8.51 % | https://www.rbi.org.in/Scripts/BS_PressReleaseDisplay.aspx?prid=63049 | LIVE (rbi_pr.py, 15 mthly obs from "Lending and Deposit Rates of SCBs" PRs; WALR fresh rupee loans). Each release's parenthetical prior-month figure matches the prior release's print (e.g. Apr-26 8.50). |
| personal_loans | 2026-05 | 15.4 % YoY | https://www.rbi.org.in/Scripts/BS_PressReleaseDisplay.aspx?prid=63052 | LIVE (rbi_pr.py, 15 mthly obs from Sectoral Deployment PRs, as-printed). CAVEAT: from Dec-2025 growth is computed on end-of-month vs old-fortnight base (Banking Laws (Amendment) Act 2025) — later releases' year-ago comparators differ from original prints (May-25 printed 13.7; May-26 release cites 11.1 on the new basis). Series keeps original prints. |
| repo | 2026-06 (month-end) | 5.25 % | https://www.rbi.org.in/Scripts/WSSViewDetail.aspx?TYPE=Section&PARAM1=4 | SEEDED (repo.json, 120 mthly obs Jul-2016..Jun-2026 from public MPC history). Feb-2025→Jul-2026 leg verified week-by-week against WSS "Ratios and Rates" Policy Repo Rate row (6.50→6.25 Feb-25→6.00 Apr-25→5.50 Jun-25→5.25 Dec-25, held to 2026-07-03); current level confirmed by MMO corridor (SDF 5.00/MSF 5.50). |
| liquidity | 2026-07-07 | +1.258 ₹ lakh cr (surplus) | https://www.rbi.org.in/scripts/bs_viewmmo.aspx | LIVE (rbi_pr.py, 24 daily obs from "Money Market Operations" PRs; series = −(line F net injection)/1e5 so positive = surplus per catalog). Latest matches the bs_viewmmo.aspx page for the same day (F = −1,25,832 cr). Sign flip vs MMO convention documented in fetcher docstring. |
| gsec10y | 2026-07-01 | 6.76 % | https://www.fbil.org.in/ (API /wasdm/gsec/downloadPublished) | LIVE (fbil.py, 24 daily obs; FBIL 10Y par yield, SEMI-ANNUAL column). Convention verified vs RBI WSS "10-Year G-Sec Par Yield (FBIL)": week-ended 19-Jun-26 both 6.87. NB: level ~6.7-7.0% is above the ~6.2-6.6 prior — confirmed by two independent RBI/FBIL prints; FBIL publication lags ~1 week. |
| inrusd | 2026-07-08 | ₹ 95.2236 | https://www.rbi.org.in/scripts/referenceratearchive.aspx | LIVE (rbi_refrate.py, 41 daily obs via VIEWSTATE postback, FBIL reference rate). Cross-checked vs WSS Ratios & Rates INR-US$ spot prints (94.47-95.40 in Jun-26) and the ~95-96/USD level per NSDL FPI page. |
| gnpa | H2 FY26 (as at Mar-2026) | 1.8 % | https://www.rbi.org.in/Scripts/FsReports.aspx | SEEDED (gnpa.json, 15 half-yr obs Mar-19..Mar-26; obs dated by Mar/Sep reference month). Mar-26 = 1.8% read from FSR Jun-2026 PDF ("multi-decadal low"), confirmed by press (ThePrint). Sep-25 2.2 / Mar-25 2.3 from FSR Dec-25/Jun-25 PDFs; Mar-23/Sep-23/Mar-24 from FSR press releases (prids 55943/57005/58169); older points = FSR public record. |
